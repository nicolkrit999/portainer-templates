...
- [tailscale-admin + traefik-tailnet-forwarder service](tailscale_admin_traefik_tailnet_forwarder_service.md) - MERGED 2026-09-08 (was two separate stacks) after an independent-redeploy-timer incident left the forwarder in a stale network namespace; second Tailscale identity + HAProxy PROXY-protocol sidecar sharing its namespace; residual-risk detection/fix documented in core-infra-topology.md
